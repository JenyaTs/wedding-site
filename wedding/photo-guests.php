...
<?php include 'menu.php'; ?>
        ...
        <div class="container">
          ...
          <!-- /.section-subtitle -->
          <div class="row justify-content-center guests-slider-container">
            <div class="slider-albumguest-arrow slider-albumguest-arrow-right"></div>
            <div class="slider-albumguest-arrow slider-albumguest-arrow-left"></div>
            <div class="image-box-container">             
             <div class=" image-box-guest image-box-guest-s" style="width: 9999px; position: relative">      
