        ...
        <div class="container">
          ...
          <div class="row justify-content-center">
            <div class="book-block">
              <div class="slider-book">
                ...
                <div class="slider-book-arrow slider-book-arrow-right"></div>
                <div class="slider-book-arrow slider-book-arrow-left">
                </div>
            ...
            <div class="book-ellips">
              <div class="dots-container grats-dots-container">
                <div class="dot grats-dot"></div>
              </div>
              <div class="dots-container wish-dots-container">
                <div class="dot wish-dot"></div>
              </div>
            </div> 
          </div>
          <!-- /.row -->
          ...
          <div class="row justify-content-center align-items-center">
            ...
            <div class="col-12 col-lg-6 d-flex justify-content-center d-xl-flex justify-content-end">
              ...
              <form class="form-book wish-form" method="POST">
            ...
            <div class="col-12 col-lg-6 d-flex justify-content-center d-lg-flex justify-content-start">
              <form class="form-book grats-form" method="POST">
	      ...
	      <!-- /.builder6 -->
  <!-- <script src="dist/BookWishes.js"></script> -->
